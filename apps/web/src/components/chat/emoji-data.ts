...
export const STICKER_CATEGORIES: StickerCategory[] = [
  {
    ...
    label: 'Animated',
    emoji: '⚡',
    items: [...STICKER_ANIMATED].map(
      (e) => [e, 'animated gif fun express live'] as [string, string],
    ),
  },
  {
    id: 'smileys',
  ...
  },
  {
    ...
    items: [
      ...
      ['✋', 'hand raised stop'],
      ['🖖', 'vulcan live long star trek'],
      ['🫰', 'finger heart'],
      ['✊', 'fist power'],
      ['🤛', 'fist left'],
      ['🤜', 'fist right'],
      ['👏', 'clap applause'],
      ['🙌', 'raised celebrate hooray'],
      ['👐', 'open hands'],
      ['🤲', 'palms together thanks'],
      ['🤝', 'handshake deal'],
      ['🙏', 'pray thanks please'],
      ['💪', 'muscle strong flex'],
      ['🦾', 'mechanical arm'],
